...
public class Delivered_detail extends AppCompatActivity {
   ...
   // Button bt_delivered;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delivered_detail);

        //bt_delivered = findViewById(R.id.bt_delivered);
        ...
        ordersService.detail(SharedPreferencesHandler.loadAppData(this),String.valueOf(order.get_id()) ).enqueue(new Callback<Order>() {
            ...
            public void onFailure(Call<Order> call, Throwable t) {
                Toast.makeText(Delivered_detail.this , t.getMessage(), Toast.LENGTH_SHORT).show();
      ...
      //  bt_delivered.setOnClickListener(v -> Toast.makeText(getApplicationContext(), "Delivered", Toast.LENGTH_SHORT).show());
    }
}