...
public class Delivering_detail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delivering_detail);

        bt_delivering = findViewById(R.id.bt_delivering);
        ...
        ordersService.detail(SharedPreferencesHandler.loadAppData(this),String.valueOf(order.get_id()) ).enqueue(new Callback<Order>() {
            ...
            public void onFailure(Call<Order> call, Throwable t) {
                Toast.makeText(Delivering_detail.this , t.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        bt_delivering.setOnClickListener(v -> ordersService.isdelivered(SharedPreferencesHandler.loadAppData(this), String.valueOf(order.get_id())).enqueue(new Callback<Order>(){
            @Override
            public void onResponse(Call<Order> call, Response<Order> response) {
                if (response.isSuccessful() && response.body() != null){
                    Toast.makeText(Delivering_detail.this , "Product is delivered" , Toast.LENGTH_SHORT).show();                    bt_delivering.setBackgroundDrawable(getResources().getDrawable(R.drawable.dash_bg4));

                    //change color button if call api Successfully
                    bt_delivering.setBackgroundDrawable(getResources().getDrawable(R.drawable.dash_bg4));
        ...
        /*bt_delivering.setOnTouchListener(new View.OnTouchListener() {
            @Override
